...
SimData.WRFFile = 'SourceWRF'; 

% Min WRF site altitude in meters AGL
SimData.MinWRFAlt = 0;

% Max WRF site altitude in meters AGL 
SimData.MaxWRFAlt = 100;

% Number max of topography blocks
SimData.MaxTerrainSize = 20000;

% Number of WRF sites
SimData.MaxNbStat = 100; 
...
fprintf('Lowering minimum altitude to 0\n')
